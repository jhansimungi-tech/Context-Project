...
async def run_test():
    ...
    try:
        ...
        try:
            ...
            raise AssertionError("Test case failed: Verifying the Sponsorship section displays the empty-state message 'No sponsorships found' when there are no booked puja sponsorships — the expected message did not appear (or sponsorship details were visible unexpectedly).")
