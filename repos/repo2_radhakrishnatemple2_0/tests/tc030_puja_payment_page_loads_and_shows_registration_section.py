...
async def run_test():
    ...
    try:
        ...
        try:
            ...
            raise AssertionError("Test case failed: Expected the Puja Payment page to display the 'Registration' section, but the 'Registration' text/element was not visible — the /puja-payment page may not have loaded correctly or the registration section failed to render")
        ```
