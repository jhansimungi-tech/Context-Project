...
async def run_test():
    ...
    try:
        ...
        try:
            ...
            raise AssertionError("Test case failed: Expected the 'Date is required' validation message after clicking 'Proceed to payment' with no date selected, but the message did not appear — the form may have allowed progression to payment or the validation is missing.")
