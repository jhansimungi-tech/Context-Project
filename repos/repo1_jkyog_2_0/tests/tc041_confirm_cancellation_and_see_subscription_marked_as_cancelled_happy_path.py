...
async def run_test():
    ...
    try:
        ...
        try:
            ...
            raise AssertionError("Test case failed: verifying that confirming the cancellation updates the subscription card to show 'Cancelled' status — the 'Cancelled' label was not visible after confirmation")
